...
describe('Golder', () => {
  ...
  describe('golding', () => {
    ...
    describe('routes', () => {
      ...
      it('regolds if files are beyond the refresh rate', () => golder.gold()
        .then(() => {
      ...
      it('does not regold if the files are fresh enough', () => golder.gold()
        .then(() => {
      ...
      it('warns when a regold is necessary but there is a network issue', () => golder.gold()
        .then(() => {
          fs.utimesSync(homepagePath, 1, 1);
  ...
  describe('server', () => {
    it('makes a request mock server', () => golder.gold()
      .then(() => {
    ...
    it('mocks simple request object params', () => golder.gold()
      .then(() => {
        // restore this request to be able to test the mocking
        request.get.restore();
        golder.mockRequest(sandbox, request);
    ...
    it('mocks full request object params', () => golder.gold()
      .then(() => {
        // restore this request to be able to test the mocking
        request.get.restore();
        golder.mockRequest(sandbox, request);
